    ...
    return (
        <div className="setpin-container">
            <div className="service-header sleek-service-header">
                ...
                <div>
                    <h1 className="service-title">NIN Personalization</h1>
                    <div className="service-desc">Personalize your NIN record by submitting your Tracking ID and Transaction PIN.</div>
                </div>
            </div>
